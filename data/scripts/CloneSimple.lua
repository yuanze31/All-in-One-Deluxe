...
local objTypes = {'PersonalSink', 'MedicineCabinet', 'AccountingTable', "Bed", "BunkBed", "Light", "Crib", "PlayMat",
                  ...
                  "MorgueSlab", "PowerStation", "Capacitor", "PowerSwitch", "WaterPumpStation", "WaterBoiler",
                  "PipeValve", "Sprinkler", "Drain", "MetalDetector", "WeightsBench", "PhoneBooth", "Tv", "LargeTv",
                  "PoolTable", "Cctv", "CctvMonitor", "DoorControlSystem", "PhoneMonitor", "Servo", "DoorTimer",
                  "LogicCircuit", "LogicBridge", "PressurePad", "StatusLight", "LaundryMachine", "IroningBoard",
                  "WorkshopSaw", "WorkshopPress", "CarpenterTable", "VisitorTable", "VisitorTableSecure", "DogCrate",
                  "GuardLocker", "WeaponRack", "SofaChairSingle", "SofaChairDouble", "DrinkMachine", "ArcadeCabinet",
                  "Radio", "Altar", "Pews", "PrayerMat", "LibraryBookshelf", "SortingTable", "ShopFront", "ShopShelf",
                  "GuardTower", "Radiator"}
