...
local objTypes = {'PersonalSink', 'MedicineCabinet', 'AccountingTable', "Bed", "BunkBed", "Crib", "PlayMat", "Toilet",
                  "Table", "Chair", "Bench", "ElectricChair", "JailDoor", "JailDoorLarge", "JailDoorXL", "Door",
                  "StaffDoor", "SolitaryDoor", "RemoteDoor", "JailBars", "Window", "WindowLarge", "Cooker", "Fridge",
                  "Bin", "Sink", "ServingTable", "ShowerHead", "Bookshelf", "OfficeDesk", "SchoolDesk", "FilingCabinet",
                  "MedicalBed", "MorgueSlab", "PowerStation", "Capacitor", "PowerSwitch", "WaterPumpStation",
                  "WaterBoiler", "PipeValve", "Sprinkler", "Drain", "MetalDetector", "WeightsBench", "PhoneBooth", "Tv",
                  "LargeTv", "PoolTable", "Cctv", "CctvMonitor", "DoorControlSystem", "PhoneMonitor", "Servo",
                  "DoorTimer", "LogicCircuit", "LogicBridge", "PressurePad", "StatusLight", "LaundryMachine",
                  "IroningBoard", "WorkshopSaw", "WorkshopPress", "CarpenterTable", "VisitorTable",
                  ...
                  "SortingTable", "ShopFront", "ShopShelf", "GuardTower", "Radiator", "Light"}
